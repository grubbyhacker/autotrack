...
phase1 phase2 phase3 phase4 phase4_pads phase4_rampjump phase4_crestdip phase4_chicane phase4_5 phase4_5_geometry phase4_5_lap phase4_5_speed phase5 phase5_unit phase6 phase6_unit phase6_integration phase7 phase7_unit phase7_integration:
	@$(PYTHON) $(TEST_CLI) run "$@"
