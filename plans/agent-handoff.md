...
- Static/contract gates after `90 / 107` strict: `make typecheck`, `make fmt-check`, `make lint`, `make test-contracts`; broader maintained gates: `make typecheck-report`, `make hygiene`; type/refactor gates: `make phase30`, `make phase36`, `make phase37`, `make phase39`
